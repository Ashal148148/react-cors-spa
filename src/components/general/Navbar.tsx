...
function Navbar(){
    const something = "block py-1 px-4 md:bg-transparent md:dark:text-blue-500"
        ...
        <nav className="shadow-2xl bg-[#D4E1F6] dark:bg-gray-900 border-none fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className=" flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-row md:p-0 mt-4 text-black text-2xl font-medium rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li >
