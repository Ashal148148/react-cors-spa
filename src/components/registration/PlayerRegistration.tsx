...
function PlayerRegistration({ setPlayerName, setPlayerJob, setPlayerMapleWarriorPercent}: { setPlayerName: (levels: string) => void,
     setPlayerJob: (job: Job) => void, setPlayerMapleWarriorPercent: (percent: number) => void}): React.JSX.Element {
    return (
      <div className='bg-gradient-to-r from-[#DDF9FF] to-[#ADBEE9] rounded-3xl p-10 mb-6'>
          ...
          <div className='flex flex-row justify-center'>
            <form className='max-w-sm grow mr-10'>
              ...
              <Input className='p-2.5' onBlur={(event) => setPlayerName(event.target.value)}/>  
            </form>  
