...
function Equipment({equip, removeEquip, index}: {equip: EquipmentI, removeEquip: (index: number) => void, index: number}): React.JSX.Element {
    return (
      <div className="group flex flex-col items-center p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
